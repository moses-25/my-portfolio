  ...
  return (
    <>
      ...
      >
        <div
          className="
            flex flex-col items-center gap-1 py-6 px-3
            backdrop-blur-md
              ...
              return (
                <li key={item.sectionId}>
                  ...
                  >
                    ...
                    {/* Tooltip */}
                    <span className="absolute left-full ml-3 px-2.5 py-1 bg-gray-900 text-white text-xs font-medium rounded-lg whitespace-nowrap opacity-0 pointer-events-none -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-150 shadow-lg">
                      {item.label}
                    </span>
                  </button>
                </li>
